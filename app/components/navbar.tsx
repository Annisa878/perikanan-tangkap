          ...
          <div className="hidden md:flex space-x-1 items-center">
            {role === "admin" ? (
              <>
                ...
                <NavLink href="/pages/admin/data_pengajuan" icon={<FileBarChart size={16} />}>Data Pengajuan</NavLink>
                <NavLink href="/pages/admin/monitoring" icon={<FileBarChart size={16} />}>Data Monitoring</NavLink>
              </>
            ) : role === "kepala bidang" ? (
              <>
                  ...
                  <AnimatePresence>
                    {isLayananUtamaOpen && (
                      <motion.div
                        ...
                        className="absolute left-0 mt-1 w-56 bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden z-50" // Adjusted width
                      >
                        <div className="py-1">
                  ...
                  <AnimatePresence>
                    {isRiwayatOpen && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: 10 }}
                        transition={{ duration: 0.2 }}
                        className="absolute left-0 mt-1 w-48 bg-white rounded-lg shadow-xl border border-gray-100 overflow-hidden z-50"
                      >
                        <div className="py-1">
              ...
              <div className="bg-white shadow-lg rounded-b-lg mx-4 mb-4 overflow-hidden">
                {role === "admin" ? (
                  ...
                  <>
                    ...
                    <MobileNavLink href="/pages/kepala-bidang/verifikasi_monitoring" icon={<ClipboardList size={18} />}>Verifikasi Monitoring</MobileNavLink>
                  </>
                ) : role === "kepala dinas" ? (
                  <>
...
const NavLink = ({ href, icon, children }: { href: string; icon: React.ReactNode; children: React.ReactNode }) => {
  ...
  return (
    <Link 
      ...
      className={`flex items-center px-3 py-2 text-sm font-medium rounded-full transition-all duration-300 ${
        scrolled
          ? "text-sky-700 hover:bg-sky-100" // Scrolled NavLink
